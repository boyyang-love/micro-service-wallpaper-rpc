...
func (m *defaultUpload) CosUpload(ctx context.Context, in *ImageUploadReq, opts ...grpc.CallOption) (*ImageUploadRes, error) {
	client := upload.NewUploadClient(m.cli.Conn())
	return client.CosUpload(ctx, in, opts...)
}

func (m *defaultUpload) CosDelete(ctx context.Context, in *ImageDeleteReq, opts ...grpc.CallOption) (*Base, error) {
	client := upload.NewUploadClient(m.cli.Conn())
	return client.CosDelete(ctx, in, opts...)
}
