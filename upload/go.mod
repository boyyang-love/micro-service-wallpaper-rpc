module github.com/boyyang-love/micro-service-wallpaper-rpc/upload

go 1.23.1

require (
	github.com/boyyang-love/micro-service-wallpaper-models v0.0.0-20250221051219-b4682a3020d9
