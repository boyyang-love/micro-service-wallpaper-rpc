...
const (
	User_AddUser_FullMethodName    = "/upload.User/AddUser"
	User_UpdateUser_FullMethodName = "/upload.User/UpdateUser"
	User_UserInfo_FullMethodName   = "/upload.User/UserInfo"
)
